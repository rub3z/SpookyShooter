...
public class Utilities {
   ...
   public static final short MASK_ENEMY= CATEGORY_PLAYER | CATEGORY_PLAYER_PROJECTILE|CATEGORY_PLAYER_SPECIAL_PROJECTILE; // Enemy can collide with player and player's projectile
